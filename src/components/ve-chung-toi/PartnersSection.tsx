        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4">
              Đối tác <span className="text-brand-accent">uy tín</span>
            </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8">
            {partners.map((partner, index) => (
              <div
                ...
                data-animate
                id={`partner-${index}`}
                className={`bg-white rounded-2xl p-6 border-2 border-gray-100 hover:border-brand-accent/50 transition-all duration-300 hover:shadow-lg flex items-center justify-center h-24 sm:h-32 ${isVisible.has(`partner-${index}`) ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
