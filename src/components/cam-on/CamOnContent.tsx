...
export default function CamOnContent() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (savedOrderInfo) {
        ...
        const newOrderInfo = { orderId, orderDate };
        localStorage.setItem('lastOrderInfo', JSON.stringify(newOrderInfo));
  ...
  if (!orderInfo) {
    return null; // Don't render until we have order info
  }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  ...
                  <span className="font-bold text-gray-900">#{orderInfo.orderId}</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
